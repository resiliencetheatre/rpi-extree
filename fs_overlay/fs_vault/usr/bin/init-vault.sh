...
echo "For 'git' access: "
echo " "
echo " Create password for git user:"
echo "  passwd git"
echo " "
echo " Add ssh key:"
echo "  mkdir -p /home/git/.ssh/"
echo "  echo [key] > /home/git/.ssh/authorized_keys"
echo " "
echo " Change git-shell to /etc/passwd:"
echo "  git:x:1001:1001:Linux User,,,:/home/git/:/bin/git-shell"
echo " "
echo " Add 'git-shell' to /etc/shells:"
echo "  /bin/git-shell"
echo " "
echo " Copy git-shell commands"
echo "  cp -r git-shell-commands/ /home/git/"
echo " "
echo " Ensure permissions:"
echo "  chown -R git:git /home/git"
echo " "
echo " Test from host:"
echo " "
echo "  $ ssh git@rpi"
echo "  Hi git! You've successfully authenticated, but I do not"
echo "  provide interactive shell access."
echo "  Connection to vault closed"
echo " "
echo " "
