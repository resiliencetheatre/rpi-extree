# Check that your config.txt has:
#
# dtparam=spi=on
# dtparam=i2c_arm=on
# dtparam=i2s=on
...
# Raspberry Pi Zero / Zero 2 W BCM GPIO numbers
GPIOCHIP = "/dev/gpiochip0"
PIN_DC = 27      # physical pin 13
PIN_RST = 4      # physical pin 7
PIN_BL = 22      # physical pin 15, active-low on your board
...
LCD_W = 240
LCD_H = 280
Y_OFFSET = 20    # Whisplay/ST7789 panel offset used by vendor code
...
# ---- tiny 5x7 font ----
# Each character is 5 columns, LSB at top.
FONT = {
...
class WhisplayLCD:
    def __init__(self):
        ...
        self.bl = GPIOOut(self.chip, PIN_BL, 1)  # off initially
    ...
    def backlight(self, on):
        # Whisplay backlight is active-low
    ...
    def init_lcd(self):
        ...
        self.cmd(0x36, 0xC0) # MADCTL, same orientation style as vendor code
        self.cmd(0x3A, 0x05) # RGB565 / 16-bit color
...
def main():
    ...
    draw_text(fb, 20, 35, "WHISPLAY", YELLOW, scale=4)
    draw_text(fb, 20, 85, "SPI OK", GREEN, scale=4)
    draw_text(fb, 20, 135, "NO PYGAME", WHITE, scale=3)
    draw_text(fb, 20, 170, "NO PIL", WHITE, scale=3)
    draw_text(fb, 20, 220, "ZERO 2W", BLUE, scale=3)
